...
const Map<String, Map<AppLang, String>> _strings = {
  ...
  'connect.tabConfigure': {AppLang.en: 'Configure', AppLang.zh: '配置'},
  'connect.tabBrowse': {AppLang.en: 'Browse', AppLang.zh: '浏览'},
  'connect.tabCommand': {AppLang.en: 'Command', AppLang.zh: '命令'},
  'connect.tabScript': {AppLang.en: 'Script', AppLang.zh: '脚本'},
