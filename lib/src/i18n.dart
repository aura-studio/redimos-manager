...
const Map<String, Map<AppLang, String>> _strings = {
  ...
  'tbl.rowActions': {AppLang.en: 'Row actions', AppLang.zh: '行操作'},
  ...
  'tbl.editSelected': {AppLang.en: 'Edit selected', AppLang.zh: '编辑所选'},
  'tbl.duplicateSelected': {AppLang.en: 'Duplicate selected', AppLang.zh: '复制所选'},
  'tbl.deleteSelected': {AppLang.en: 'Delete selected', AppLang.zh: '删除所选'},
